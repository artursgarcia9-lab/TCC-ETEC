...
<html lang="pt-br">
    <head>
        ...
        <title>Órgãos Públicos - EasyMigra</title>
    ...
    <body>
        <header class="app-header-orgaos">
        ...
        <main>
            ...
            <form method="GET">
                <input type="text" name="busca" placeholder="Buscar por nome ou endereço" value="<?php echo htmlspecialchars($termo); ?>">
