...
<html lang="pt-br">
    <head>
        ...
        <style>
            ...
            main{max-width:800px;margin:30px auto;background:white;padding:25px;border-radius:10px} 
            input,button{padding:10px;margin:5px 0} 
            table{width:100%;border-collapse:collapse} 
            th,td{border-bottom:1px solid #ddd;padding:10px;text-align:left} 
            .danger{background:#dc3545;color:white;border:0;border-radius:4px}
        </style>
        </head>
