...
class FormacaoAcad
{
    ...
    //Insere uma nova formação acadêmica na tabela
    public function inserirBD()
    {
        ...
        try {
            ...
            echo "Erro ao inserir formação: " . $e->getMessage();
            return false;
        }
    }

    //Remove uma formação acadêmica pelo seu ID
    public function excluirBD($id)
    {
        ...
        try {
            ...
            echo "Erro ao excluir formação: " . $e->getMessage();
            return false;
        }
    }

    //Retorna todas as formações acadêmicas de um usuário específico
